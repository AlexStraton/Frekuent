...
export default function NavBar() {
  return (
    <nav className="flex justify-between items-center p-4">
      ...
      <Link to="/Home"  className="hover:bg-sky-400 rounded transition-all duration-600 ease-in-out px-6">Home</Link>
      <Link to="/MySchedule"  className="hover:bg-sky-400 rounded transition-all duration-600 ease-in-out px-6">My Schedule</Link>
